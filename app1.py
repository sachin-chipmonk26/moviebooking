...
def split_documents(self, text):
    ...
    for i, chunk in enumerate(self.chunk_text(text)):
        document = Document(
            page_number=i + 1,  # You can adjust this as needed
            page_content=chunk
        )
...
def main():
    ...
    # Read CSV file from project directory
    csv_file_path = 'concept_description_pairs.csv'  # Replace with your actual CSV file name
    df = pd.read_csv(csv_file_path)

    # Process text from the 'text' column
